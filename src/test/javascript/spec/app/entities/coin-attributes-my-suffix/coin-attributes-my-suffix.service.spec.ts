...
describe('Service Tests', () => {
    ...
    describe('CoinAttributesMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CoinAttributesMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/coin-attributes';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CoinAttributesMySuffix', () => {

                let entity: CoinAttributesMySuffix;
                service.find(123).subscribe((_entity: CoinAttributesMySuffix) => {
                    entity = _entity;
                });
