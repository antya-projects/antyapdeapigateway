...
describe('Service Tests', () => {
    ...
    describe('CoinMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CoinMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/coins';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CoinMySuffix', () => {

                let entity: CoinMySuffix;
                service.find(123).subscribe((_entity: CoinMySuffix) => {
                    entity = _entity;
                });
