...
describe('Service Tests', () => {
    ...
    describe('ExchangeMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ExchangeMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/exchanges';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ExchangeMySuffix', () => {

                let entity: ExchangeMySuffix;
                service.find(123).subscribe((_entity: ExchangeMySuffix) => {
                    entity = _entity;
                });
